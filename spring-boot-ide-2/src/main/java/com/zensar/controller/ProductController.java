...
@RestController
@RequestMapping(value = "/product-api", produces = { MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE })
...
// @RequestMapping("/products")
   ...
   public ResponseEntity<List<ProductDto>> getByProductNameAndProductPrice(@PathVariable String productName,@PathVariable int productPrice) {
